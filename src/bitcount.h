...
inline uint8_t Count1s(uint8_t Byte) {
    return ByteCount1s[Byte & 0x0F] + ByteCount1s[Byte >> 4];
}
#else
inline uint8_t Count1s(uint8_t Byte) {
    return ByteCount1s[Byte];
}
#endif

inline uint8_t Count1s(int8_t Byte) {
    return Count1s((uint8_t)Byte);
}

inline uint8_t Count1s(uint16_t Word) {
    return Count1s((uint8_t)Word) + Count1s((uint8_t)(Word >> 8));
}

inline uint8_t Count1s(int16_t Word) {
    return Count1s((uint16_t)Word);
}

inline uint8_t Count1s(uint32_t LongWord) {
    return Count1s((uint16_t)LongWord) + Count1s((uint16_t)(LongWord >> 16));
}
...
inline uint8_t Count1s(uint64_t LongWord) {
    return Count1s((uint32_t)LongWord) + Count1s((uint32_t)(LongWord >> 32));
}
